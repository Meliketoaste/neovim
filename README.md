# This is a heavily modified repo from github.com/Iogamaster/neovim repo.
...
```sh
nix run github:Meliketoaste/neovim
```

Or without Nix:
```
git clone https://github.com/Meliketoaste/neovim --depth=1 ~/.config/nvim/ && nvim
```
